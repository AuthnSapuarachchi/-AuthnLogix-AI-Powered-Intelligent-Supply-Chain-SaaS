...
public class JwtService {
    ...
    // 🛑 REAL WORLD WARNING: In production, store this in application.yml or Environment Variable!
    // For now, we hardcode a 256-bit key for learning purposes.
