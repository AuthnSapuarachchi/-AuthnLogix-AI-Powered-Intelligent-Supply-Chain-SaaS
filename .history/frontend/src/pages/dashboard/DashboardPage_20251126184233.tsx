...
import { useInventorySocket } from "../../shared/api/useInventorySocket";
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        {/* New Shipment Navigation Card */}
          <div className="p-6 bg-gray-900 rounded-xl border border-gray-800 flex flex-col justify-between">
            <div>
              <h3 className="text-lg font-semibold mb-2">Logistics & Orders</h3>
              <p className="text-sm text-gray-400">Process outbound shipments and deliveries.</p>
            </div>
            <Button className="mt-4" variant="outline" onClick={() => navigate("/shipments")}>
              Manage Shipments
            </Button>
          </div>
