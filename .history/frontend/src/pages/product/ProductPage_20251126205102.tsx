    ...
    <div className="min-h-screen bg-gray-950 text-white p-8">
      ...
      {selectedSku && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-xl text-center space-y-4 relative">
            <button 
            ...
            <h3 className="text-black font-bold text-lg">Scan to Identify</h3>
            <div className="p-2 border-2 border-black inline-block">
                <QRCode value={selectedSku} size={150} />
            </div>
            <p className="text-black font-mono text-sm">{selectedSku}</p>
          </div>
        </div>
      )}{/* --- QR CODE MODAL --- */}
      {selectedSku && (
