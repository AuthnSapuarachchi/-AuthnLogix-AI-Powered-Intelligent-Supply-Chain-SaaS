...
const stripePromise = loadStripe("pk_test_51SY0juHIrDOOZus5tIaXftx3DbJZ3yBHgTtiznbH7pjGbN7sBBUN9nSO3de7tqyTxGMaamgH9i2TFJlisomAHpxm00zqHDZCpw"); // <--- PASTE KEY HERE
...
export const SubscriptionPage = () => {
  ...
  useState(() => {
    api
      .post("/payments/create-intent", { amount: 50.0 })
      .then((res) => setClientSecret(res.data.clientSecret))
      .catch((err) => alert("Failed to init payment"));
  });

  if (!clientSecret)
    return <div className="text-white p-10">Loading Payment System...</div>;
