  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 ${userRole === 'ADMIN' ? 'md:grid-cols-3' : 'md:grid-cols-1'} gap-8`}">
          {/* LEFT: Data Table */}
          <div className={`${userRole === 'ADMIN' ? 'md:col-span-2' : 'md:col-span-1'} bg-gray-900 rounded-xl border border-gray-800 p-6`}>
