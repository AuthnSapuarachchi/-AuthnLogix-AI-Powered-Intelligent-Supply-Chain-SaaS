...
import { useCreateWarehouse, useWarehouses } from "../../entities/warehouse/model/useWarehouses";
import { CreateWarehousePayload } from "../../entities/warehouse/model/types";
...
export const WarehousePage = () => {
  ...
  // 2. Form Setup
  const { register, handleSubmit, reset, formState: { errors } } = useForm<CreateWarehousePayload>();
  ...
  const onSubmit = (data: CreateWarehousePayload) => {
    ...
    createWarehouse({ ...data, capacity: Number(data.capacity) }, {
    ...
    <div className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8 border-b border-gray-800 pb-4">
          <h1 className="text-3xl font-bold text-blue-500">Warehouse Manager</h1>
          ...
          <div className="md:col-span-2 bg-gray-900 rounded-xl border border-gray-800 p-6">
            ...
            {isLoading ? (
              ...
              <div className="overflow-x-auto">
                ...
                {warehouses?.length === 0 && (
                    <p className="text-center py-4 text-gray-500">No warehouses found.</p>
                )}
              </div>
            )}
          </div>
